...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("Đang Kiểm tra website: " + url);
        ...
        System.out.println("Tool DDoS By: Xuan Quyen 𓆈");
    ...
    private void checkConnection(String url) throws Exception {
        ...
        if (responseCode == 200) {
            System.out.println("Kết nối thành công với Website");
        }
        Dos.url = url;
    }

    private void sslCheckConnection(String url) throws Exception {
        System.out.println("Đang kiểm tra Connection (ssl)");
        URL obj = new URL(url);
